# The exercises below use only what was available in the chapter -- so no variables.
# Expressions which resulted in an error are commented out.
...
# 3.
#round(42.5  # output: SyntaxError: '(' was never closed     ... also cannot run in terminal environment: keeps breaking into new line
